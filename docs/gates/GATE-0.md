...
| `pnpm test:e2e`                 | `5/5` scénarios Chromium réussis : contrat, clavier/focus, validation, hors-ligne et responsive 599/600 px                                    | VERT local                                   |
...
| Vérifier WCAG 2.2 AA, zoom/reflow, une action principale     | PARTIEL    | `X-01` prouve clavier, focus, cibles de 44 px et bascule responsive 599/600 px sans débordement horizontal dans Chromium ; lecteur d’écran, zoom 200 %, reflow 400 % et audit complet restent à produire.                 |
