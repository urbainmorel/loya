...
| `pnpm test`                     | `41/41` tests réussis : `32` garde-fous Node, `2` unitaires et `7` dans le runtime Workers                                                    | VERT                                         |
...
| CI distante                     | baseline historique verte ; le workflow courant exécute désormais `pnpm check`, Gitleaks et l'audit SCA, mais attend la PR du POC             | À PROUVER SUR LA PR                          |
...
| Prototype des trois intentions sans autorisation                                             | NON PROUVÉ                | Le shell `apps/web` existe ; `X-01..X-06` et l'API d'intention restent absents.                                |
...
| Configuration expurgée, prototype `X-01..X-06`, tests d'e-mail et matrice intention→contexte | NON PROUVÉ                | Configuration locale partielle ; prototypes, tests et matrice restent absents.                                 |
